...
class OrderProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_product" do
    assert_difference('OrderProduct.count') do
      post order_products_url, params: { order_product: { orders_id: @order_product.orders_id, products_id: @order_product.products_id, quantity: @order_product.quantity } }
    end
  ...
  test "should update order_product" do
    patch order_product_url(@order_product), params: { order_product: { orders_id: @order_product.orders_id, products_id: @order_product.products_id, quantity: @order_product.quantity } }
